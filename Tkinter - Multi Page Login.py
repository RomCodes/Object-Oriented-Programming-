...
class FirstPage(tk.Frame):
    def __init__(self, parent, controller):
        ...
        load = Image.open(r"C:\Users\User\Pictures\Romish Suprina family photos\Starred Photos suprina Basnyat\SUPRINA BASNYAT_005.JPG")
...
class SecondPage(tk.Frame):
    def __init__(self, parent, controller):
        ...
        load = Image.open(r"C:\Users\User\Pictures\Romish Suprina family photos\Starred Photos suprina Basnyat\SUPRINA BASNYAT_020.JPG")
        photo = ImageTk.PhotoImage(load)
        label = tk.Label(self, image=photo)
        label.image=photo
        label.place(x=0,y=0)
